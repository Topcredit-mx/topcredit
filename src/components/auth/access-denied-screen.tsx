...
export async function AccessDeniedScreen({
	...
	const card = (
		<div className={cn(shell.elevatedCard, 'w-full max-w-md p-8 text-center')}>
			...
			{session?.user ? (
				<div className="space-y-4">
					...
					<AccessDeniedCtaLink href={homeHref}>
						{t('back-home')}
					</AccessDeniedCtaLink>
				</div>
			) : (
				<div className="space-y-4">
					...
					<AccessDeniedCtaLink href={loginHref}>
						{tAuth('login')}
					</AccessDeniedCtaLink>
