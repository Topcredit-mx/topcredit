	...
	return (
		<li className="flex flex-col gap-2 border-border/60 border-b py-3 last:border-b-0">
			<div className="flex min-h-8 w-full items-center gap-3 text-sm">
				<DocumentStatusIcon
					status={status}
					titlePending={t(EQUIPO_DOCUMENT_STATUS_KEYS.pending)}
					titleApproved={t(EQUIPO_DOCUMENT_STATUS_KEYS.approved)}
					titleRejected={t(EQUIPO_DOCUMENT_STATUS_KEYS.rejected)}
				/>
