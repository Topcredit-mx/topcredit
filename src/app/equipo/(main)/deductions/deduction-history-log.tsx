...
export function DeductionHistoryLog({
	items,
	title,
	description,
	emptyMessage,
	...
	items: readonly DeductionConfirmationHistoryItem[]
	title: string
	description: string
	emptyMessage: string
	...
	return (
		<section className="space-y-5" aria-labelledby="deduction-history-heading">
			<SectionTitleRow
				headingId="deduction-history-heading"
				icon={History}
				title={title}
